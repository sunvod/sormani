...
all objects on the page and produce an image-only PDF as output.
    ...
    sormani --skip-text file_with_some_text_pages.pdf output.pdf

    sormani --force-ocr word_document.pdf output.pdf
...
sending the result to OCRmyPDF through a pipe.
    ...
    img2pdf --pagesize A4 page*.png | sormani - myfile.pdf
...
""",
    ...
    advanced.add_argument(
        ...
        "environment as sormani; or you may give the path to the Python file that "
