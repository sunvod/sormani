    ...
    def setup_plugins(self):
        ...
        if self.__builtins:
            for module in sorted(
                ...
                name = f'sormani.builtin_plugins.{module.name}'
        ...
        try:
            ...
            self.register(importlib.import_module('sormani.extra_plugins.semfree'))

        # 3. Register setuptools plugins
        self.load_setuptools_entrypoints('sormani')
